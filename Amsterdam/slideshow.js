...
self.prototype = {
	...
	*/
	goto: function(which) {
      ...
      $$('embed, object').forEach(function(flash){
        flash.classList.remove('show');
      });
      $$('embed, object', this.slides[this.slide]).forEach(function(flash){
	...
	gotoItem: function(which) {
		...
		if(this.item > 0) {
      var runCode = this.items[which-1].getAttribute('run-code');
      runCode && customCodeToRun && customCodeToRun[runCode] && customCodeToRun[runCode].call(this);
